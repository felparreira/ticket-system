        ...
        <>
          {chamados.length === 0 ? (
            ...
            <>
                  ...
                  {chamados.map((item, index) => {
                    return(
                      <tr key={index}>
                        ...
                        <td data-label="Categoria">{item.assunto}</td>
                        ...
                        <td data-label="Ações">
                          ...
                          <button className="action" style={{ backgroundColor: '#d90000' }} onClick={()=>excluirTicket(item.id)}>
              ...
              {!loadingMore && !isEmpty && (chamados.length > 5) && <button className="btn-more" onClick={handleMore}>Buscar mais</button>  }  
            </>
          )}
        </>
